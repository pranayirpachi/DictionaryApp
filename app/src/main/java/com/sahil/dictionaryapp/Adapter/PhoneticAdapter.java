...
import com.sahil.dictionaryapp.Models.Phonetics;
import com.sahil.dictionaryapp.R;
import com.sahil.dictionaryapp.ViewHolders.PhoneticViewHolder;
        ...
        holder.imageButton_audio.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(context, "Student play Audio", Toast.LENGTH_SHORT).show();
                }
            }
        });
